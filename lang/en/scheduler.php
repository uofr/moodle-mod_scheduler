...
$string['absentpaid'] = 'Absent Paid';
$string['absentschedule'] = 'Absent Reschedule';
...
$string['calendar'] = 'Payroll Calendar Settings';
$string['calendar_desc'] = 'Settings for payroll calendar start date and due time.';
$string['calendarstart'] = 'Calendar Start';
$string['calendarstart_desc'] = 'Start of the pay calendar in YYYY-MM-DD format (default: 2025-08-17).';
$string['calendarstart_error'] = 'Date must be of the form YYYY-MM-DD.';
$string['calendarexception'] = 'Exception Dates';
$string['calendarexception_desc'] = 'Attendance due dates that fall on holidays.';
$string['calendarexception_error'] = 'Date list must be of the form YYYY-MM-DD, YYYY-MM-DD, YYYY-MM-DD, ..., YYYY-MM-DD';
$string['cancelbooking'] = 'Cancel booking';
$string['canceldates'] = 'Unavailable Dates';
$string['canceldates_help'] = 'Upload a csv file with column of dates in yyyy/mm/dd format';
...
$string['duetime_desc'] = 'Time attendance must be submitted by on the due date (default: 12:30 pm).';
...
$string['markseen'] = 'After you have had an appointment with a student please mark them as "Seen" by checking the checkbox near to their user picture above.';
...
$string['meetingstartdate'] = 'Meetings Start Date';
$string['meetingenddate'] = 'Meetings End Date';
...
$string['welcomenewstudent'] = 'The table below shows all available slots for an appointment. Make your choice by selecting the corresponding "Book slot" button. If you need to make a change later you can revisit this page.';
$string['welcomenewteacher'] = 'Please use the button below to add appointment slots.';
$string['what'] = 'What?';
...
$string['error:deletecalendart'] = 'Failed to remove instructor calendar event';
$string['error:deletecalendars'] = 'Failed to remove student calendar event';
$string['error:deleteappointment'] = 'Failed to remove appointment from student';
$string['error:deleteslot'] = 'Failed to remove entire lesson';
...
$string['error:invalidaction'] = 'Invalid Action {$a->action} for {$a->name} in course {$a->course}. Only add and delete allowed Skipping';
$string['error:invaliddelete'] = 'Lesson for {$a->name} in course {$a->course} on {$a->date} could not be found to be deleted.  Skipping';
...
$string['sessionsdeleted'] = '{$a} sessions were successfully deleted';
