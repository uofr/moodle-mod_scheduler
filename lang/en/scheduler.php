...
$string['markseen'] = 'After you have had an appointment with a student please mark them as "Seen" by using the appropriate checkbox in the table above.';
...
$string['welcomenewstudent'] = 'The table below shows all available slots for an appointment. Make your choice by selecting a radiobutton and don\'t forget to "Save my choice" afterwards. If you need to make a change later you can revisit this page.';
$string['welcomenewteacher'] = 'Please use the button below to add appointment slots to see all your students.';
$string['what'] = 'What?';
