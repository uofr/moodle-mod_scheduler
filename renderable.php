...
class scheduler_slot_table implements renderable {
     ...
     * @param $otherstudents any other students in the same slot
...
class scheduler_student_list implements renderable {
    ...
    public $checkboxdisable = false;

    public $checkboxname2 = false;

    public $checkboxname3 = false;
     ...
     */
    public function add_student(appointment $appointment, $highlight, $checked = false, $checkedabsentpaid = false,
      $checkedabsentschedule = false, $showgrade = true, $showstudprovided = false, $editattended = false) {
