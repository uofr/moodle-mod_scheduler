 ...
 * @copyright  2014 Henning Bostelmann and others (see README.txt)  2020 adapted by Brooke Clary for student attendance marking function
...
switch ($action) {
    case 'saveseen':
        ...
        if ($USER->id != $app->studentid) {
            require_capability('mod/scheduler:studentcanmark', $scheduler->$context);
        }

        $app->studentattend = $newseen;
        $slot->save();
        break;
}
