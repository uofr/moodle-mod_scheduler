...
class scheduler_messenger {
     ...
     * @return string fully resolved template where all data has been injected
     *
     */
     ...
     * @param $teacher A {@see $USER} object describing the attendant (teacher)
     * @param $student A {@see $USER} object describing the attendee (student)
